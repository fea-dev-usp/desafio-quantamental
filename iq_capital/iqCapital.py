...
class iq_capital_fundamentos():
    ...
    def get_fund(self, tickers, demonstrativos, ano_ini=None, ano_fim=None):
    ...
    def shares_price(self, tickers, ano_ini=None, ano_fim=None):
        ...
        self.try_click(self.driver,
                       "/html/body/table/tbody/tr[2]/td[4]/div/form/div[3]/div/div/div[1]/div[2]/div/div[4]/div[2]/div/div[2]/div/ul/li[2]/label")
        sleep(9)
...
def main():
    ...
    tickers = ['TIMP3', 'TOTS3', 'UGPA3', 'USIM5', 'VALE3', 'VIVT4', 'VVAR3', 'WEGE3', 'YDUQ3']
